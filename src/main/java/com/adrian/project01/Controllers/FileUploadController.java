...
import com.adrian.project01.Project01Application;
...
public class FileUploadController {
	...
	public String provideUploadInfo(Model model) {
		File rootFolder = new File(Project01Application.ROOT);
		...
		if (!file.isEmpty()) {
			try {
				BufferedOutputStream stream = new BufferedOutputStream(
						new FileOutputStream(new File(Project01Application.ROOT + "/" + name)));
